...
from convolution.gauss import prepare_gauss, convolve_gaussian



class TestPerformanceConvolveGaussian:
    ...
    def setup_method(self):
        ...
        _ = convolve_gaussian(
            ...
            sigma=self.sigma, E_cut=self.E_Fermi, vibration=0.0
        )
...
if __name__ == "__main__":
    ...
    perf_class = TestPerformanceConvolveGaussian()
